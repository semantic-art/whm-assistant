...
class MY_Model extends CI_Model {
        ...
        function add($options = array())
        {
                ...
                foreach ($this->fields as $field=>$setup) 
                {
        ...
        function delete_all($options = array())
        {
        ...
        function search($str,$options=FALSE){
	        $i=0;
	        if(!$options){
	        	$options = $this->fields;
	        }
        ...
        function tally($options=FALSE){
			if($options&&is_array($options)){
				$q = $this
					->db
					->where($options)
					->count_all_results($this->primary_table);
				return $q;
			}
			$q = $this
				->db
